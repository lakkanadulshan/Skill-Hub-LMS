              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1 justify-between">
                  ...
                  <div className="mt-6 flex flex-col gap-3">
                    <button
                      onClick={() => navigate(`/course-viewer/${course._id}`)} // 🟢 ශිෂ්‍යයාව Viewer එකට යවයි
                      className="w-full bg-blue-600 hover:bg-blue-750 text-white font-semibold py-3 px-4 rounded-xl transition duration-200 text-sm"
                    >
                      Continue Learning →
                    </button>
                    <button
